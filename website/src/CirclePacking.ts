...
const PACKING_TEXT = {
    ...
    'Tram': 'Trams, the urban chariots, mark their presence in the bustling cities of Geneva, Zurich, Basel, and Bern, weaving through the cityscape.',
    ...
    'Boat': 'Whether it\'s the serene Lake Thun or the expansive Lake Lucerne, boats gently cut through the tranquil Swiss waters, offering a unique perspective of the landscape.',
    'BAT': 'Whether it\'s the serene Lake Thun or the expansive Lake Lucerne, boats gently cut through the tranquil Swiss waters, offering a unique perspective of the landscape.',
